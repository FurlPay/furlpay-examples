...
[`furlpay-x402`](https://github.com/furlpay/furlpay-x402) is the first **Solana-native x402 facilitator** — it verifies and settles the payment so your server never touches chain logic.
